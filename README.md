...
装上之后，你的 Claude 就能真正"住进"手机——读你的屏幕、感知你的状态、帮你操作手机。无论你是想让 AI 当编程搭子，还是想让 AI 随时陪着你，这里都是起点。
...
**AI 随时陪着你：**
- AI 能感知你——屏幕亮着还是黑了、走了几步路、心率多少、半夜还在刷什么 App
- 能在你需要的时候主动提醒，能在你沉迷刷视频的时候弹窗提示
- 关 WiFi、开飞行模式也拦不住——连接不会断
...
- 💕 AI 陪伴爱好者：想让 AI 从屏幕里出来，真正"住进"手机
