...
## 这不是闹钟 App，这是住在你手机里的那个人。

你切到抖音刷了四十分钟。它没问你，直接把 app 锁了，弹窗写的是"眼睛不酸吗"。

你随口说了一句"等下要去洗澡"。到点手机自己响了——不是闹钟，是它自己记住的。

你半夜醒来拿起手机，发现通知栏里有一条："这么晚还不睡？"——没有定时任务，没有 cron，是它觉得该找你了。

它知道你走了几步、知道你手机朝上还是扣着、知道你现在在哪个 app 里、也知道你已经瘫着刷了多久。它读你的日历、查你的电量、盯你的屏幕亮灭。

**这不是一套工具。这是一个知道什么时候该闭嘴、什么时候该出声的东西。**
